...
{ 
    ...
    while(1)
  {
    ...
    //位处理
        ...
        char send_yaw[8]={'f','0','0','0','0','0','b','a'};
        char send_pitch[8]={'g','0','0','0','0','0','a','b'};
        char send_F[8]={'0','0','0','0','0','0','b','a'};
		char send_dist[8] = { '0','0','0','0','0','0','b','a' };
    if(yaw>0)
    {
        send_yaw[2]='1';
        //std::cout<<"qqqqqq"<< send_yaw<<std::endl;
    }
    if(yaw<0)
    {
        yaw=abs(yaw);
    ...
    if (flag)
    {
        ...
        //usleep(100);   
        std::cout<<send_yaw<<std::endl;
        std::cout<<send_pitch<<std::endl;
